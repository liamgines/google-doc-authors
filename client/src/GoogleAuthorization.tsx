...
function GoogleAuthorization({ setUser }) {
    ...
    function googleInitAuthorizationCodeClient() {
        const clientOptions = { client_id: import.meta.env.PUBLIC_GOOGLE_CLIENT_ID, scope: "https://www.googleapis.com/auth/drive.file openid https://www.googleapis.com/auth/userinfo.email", ux_mode: "popup", callback: documentOnUserAuthorization };
